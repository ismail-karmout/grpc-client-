...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest,
      test.fss.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = test.fss.Bank.ConvertCurrencyRequest.class,
      responseType = test.fss.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest,
      test.fss.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest, test.fss.Bank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<test.fss.Bank.ConvertCurrencyRequest, test.fss.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  test.fss.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  test.fss.Bank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest,
      test.fss.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest,
      test.fss.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest, test.fss.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest,
      test.fss.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest,
      test.fss.Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest, test.fss.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest,
      test.fss.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest,
      test.fss.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<test.fss.Bank.ConvertCurrencyRequest, test.fss.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(test.fss.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<test.fss.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getCurrencyStream(test.fss.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<test.fss.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<test.fss.Bank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<test.fss.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<test.fss.Bank.ConvertCurrencyRequest> fullCurrencyStream(
        io.grpc.stub.StreamObserver<test.fss.Bank.ConvertCurrencyResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                test.fss.Bank.ConvertCurrencyResponse>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public test.fss.Bank.ConvertCurrencyResponse convert(test.fss.Bank.ConvertCurrencyRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<test.fss.Bank.ConvertCurrencyResponse> getCurrencyStream(
        test.fss.Bank.ConvertCurrencyRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<test.fss.Bank.ConvertCurrencyResponse> convert(
        test.fss.Bank.ConvertCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((test.fss.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<test.fss.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_CURRENCY_STREAM:
          serviceImpl.getCurrencyStream((test.fss.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<test.fss.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return test.fss.Bank.getDescriptor();
    }
